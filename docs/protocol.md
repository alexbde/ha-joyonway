...
*   **P23B32 / P20B29:** Only tail bytes (indices 53 and higher) should be unescaped. Unescaping indices 0–52 can corrupt payload parsing, because binary status bytes in the header may accidentally match escape sequences (e.g., a status byte of `0x1B` followed by `0x11` is not an escape code, but raw data).
...
| **Blower State** | Byte 14, bit `0x08` [✅] | Byte 14, bit `0x08` [✅] | Blower ON/OFF. (P25 also mirrors at Byte 28 bit 3) |
...
Command frames are constructed with a payload (typically 14, 16, or 17 bytes) and a 4-byte CRC-32. The common command header prefix defines the panel source address (`0x20` for P25B85 vs. `0x30` for P23B32/P20B29).
...
| **Pump/Jets 1** | **Cycle (OFF → LOW → HIGH):**<br>• LOW: `... 02 02 00 00 00 C0 ...` [✅]<br>• HIGH: `... 06 04 00 00 00 C0 ...` [✅]<br>• OFF: `... 04 00 00 00 00 C0 ...` [✅] | **Left Pump ON/OFF (14-byte):**<br>• ON: `01 30 10 3C A1 06 04 00 00 02 04 00 00 00` [✅]<br>• OFF: `01 30 10 3C A1 06 00 00 00 02 04 00 00 00` [✅] | P25 uses cycle transitions; P23 has independent pump controls. |
| **Pump/Jets 2** | N/A | **Right Pump ON/OFF (14-byte):**<br>• ON: `01 30 10 3C A1 18 10 00 00 02 04 00 00 00` [✅]<br>• OFF: `01 30 10 3C A1 18 00 00 00 02 04 00 00 00` [✅] | P23 specific second pump command. |
| **Blower Control** | **Discrete ON/OFF (16-byte):**<br>• ON: `... A1 10 A1 00 00 04 04 00 C0 00 [setpoint] 00` [✅]<br>• OFF: `... A1 10 A1 00 00 04 00 00 C0 00 [setpoint] 00` [✅] | **Discrete ON/OFF (14-byte):**<br>• ON: `01 30 10 3C A1 00 00 04 04 02 04 00 00 00` [✅]<br>• OFF: `01 30 10 3C A1 00 00 04 00 02 04 00 00 00` [✅] | Blower commands. Note that index 14 is a state echo of the current setpoint on P25. |
| **Setpoint Temperature**| **Direct Set (16-byte):**<br>`01 20 10 3C A1 10 A1 00 00 80 80 00 C0 00 [temp_f] 00` [✅] | **Direct Set (16-byte):**<br>`01 30 10 3C A1 00 A1 00 00 80 80 02 04 00 [temp_f] 00` [✅] | Both directly set target setpoint in Fahrenheit. |
| **Manual Heater Toggle**| **Discrete ON/OFF (16-byte):**<br>• ON: `... A1 10 A1 00 00 08 18 00 C0 ...` [✅]<br>• OFF: `... A1 10 A1 00 00 08 11 00 C0 ...` [✅] | **Expected ON/OFF (14-byte):**<br>• ON: `01 30 10 3C A1 00 00 08 18 02 04 00 00 00` [✨]<br>• OFF: `01 30 10 3C A1 00 00 08 11 02 04 00 00 00` [✨] | Confirmed supported by P23 manuals; expected command layout. |
| **Manual Ozone Toggle**| **Discrete ON/OFF (16-byte):**<br>• ON: `... A1 10 A1 00 00 01 01 00 40 ...` [✅]<br>• OFF: `... A1 10 A1 00 00 01 10 00 40 ...` [✅] | **Expected ON/OFF (14-byte):**<br>• ON: `01 30 10 3C A1 00 00 01 01 02 04 00 00 00` [✨]<br>• OFF: `01 30 10 3C A1 00 00 01 10 02 04 00 00 00` [✨] | Confirmed supported by P23 manuals; expected command layout. |
