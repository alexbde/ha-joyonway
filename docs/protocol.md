...
| **Factory Reset** | **Factory Reset (16-byte):**<br>`01 20 10 3C A1 10 A1 00 03 00 00 00 40 00 5F 00` [✅] | N/A | Resets the controller to factory settings (captured from PB554 setup menu). |
